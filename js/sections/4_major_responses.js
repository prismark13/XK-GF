...
<details>
    ...
    <div class="content">
            ...
            <table style="border-collapse: collapse; width: 100%;">
                <thead>
                    <tr style="background-color: #f8fafc; border-bottom: 2px solid #e2e8f0;">
                        ...
                        <th style="width: 20%; padding: 12px; text-align: left; color: #64748b; font-weight: 700;">Meaning</th>
        ...
        <div class="subheader-bar">1NT Semi-Forcing & 2/1</div>
        <div class="table-wrapper">
            <table style="border-collapse: collapse; width: 100%;">
                <thead>
                    <tr style="background-color: #f8fafc; border-bottom: 2px solid #e2e8f0;">
                        <th style="width: 15%; padding: 12px; text-align: left; color: #64748b; font-weight: 700;">Bid</th>
                        <th style="width: 20%; padding: 12px; text-align: left; color: #64748b; font-weight: 700;">Response</th>
                        <th style="padding: 12px; text-align: left; color: #64748b; font-weight: 700;">Opener Rebids</th>
                    </tr>
                </thead>
                <tbody>
                    <tr style="border-bottom: 2px solid #e2e8f0;">
