...
<details>
    ...
    <div class="content">
        ...
        <div class="subheader-bar">Weak Bids & Jump Shifts (Style)</div>
        <div class="table-wrapper">
            <table style="border-collapse: collapse; width: 100%;">
                <thead>
                    <tr style="background-color: #f8fafc; border-bottom: 2px solid #e2e8f0;">
                        <th style="width: 30%; padding: 12px; text-align: left; color: #64748b;">Situation</th>
                        <th style="padding: 12px; text-align: left; color: #64748b;">Agreement</th>
                    </tr>
                </thead>
                <tbody>
